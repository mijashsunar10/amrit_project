    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <form action="{{ route('ourteam.update', $teamMember->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="bio" name="bio" rows="4" 
                              class="w-full px-4 py-2 border rounded-lg focus:ring-orange-500 focus:border-orange-500 @error('bio') border-red-500 @enderror">{{ old('bio', $teamMember->bio) }}</textarea>
                    @error('bio')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <!-- Social Media Links -->
                <div class="col-span-1">
                    <label for="instagram" class="block text-gray-700 font-medium mb-2">Instagram URL</label>
                    <input type="url" id="instagram" name="instagram" value="{{ old('instagram', $teamMember->social_instagram) }}" 
                ...
                <div class="col-span-1">
                    <label for="facebook" class="block text-gray-700 font-medium mb-2">Facebook URL</label>
                    <input type="url" id="facebook" name="facebook" value="{{ old('facebook', $teamMember->social_facebook) }}" 
            ...
            <div class="mt-8 flex justify-end space-x-4">
                <a href="{{ route('aboutus') }}" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                    Cancel
                </a>
